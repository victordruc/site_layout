...
(function() {
  ...
  document.body.addEventListener("click",e=>searchInput.classList.remove("search-navbar-active"))
})()
// Open search -----------------------------------------------<
...
function openRegistrationMenu() {
  ...
  document.body.addEventListener('click',()=>menu.classList.remove('open-menu'))
}
...
function cabinetDetailChange() {
  ...
  btn.forEach(item=>{
    item.addEventListener("pointerdown",({currentTarget})=>{
      const actionElement = currentTarget.parentElement.querySelector(".cabinet-detail-action")
      setTimeout(()=>{
  ...
  action.forEach(el=>{
    el.addEventListener("click",({currentTarget})=>{
      ...
      const siblingElement = currentTarget.parentElement.querySelectorAll(":not(.cabinet-detail-show)")
      ...
      thisElement.nextElementSibling.addEventListener("blur",()=>{
        thisElement.style.display= null
        siblingElement.forEach(item=>item.style.display= null)
      },{once:true})
      thisElement.nextElementSibling.addEventListener("change",({currentTarget})=>{
