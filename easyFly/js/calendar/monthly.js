...
(function ($) {
	...
	$.fn.extend({
		...
		function setMonthly(month, year) {
			...
			$(parent + " .monthly-next").attr('data-month', month)
			$(parent + " .monthly-next").attr('data-year', year)
			$(parent + " .monthly-prev").attr('data-month', month)
			$(parent + " .monthly-prev").attr('data-year', year)
